    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-2 mx-auto">
        ...
        <div class="items-center justify-between w-full lg:w-auto lg:order-1 hidden lg:block" id="mobile-menu">
            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                    <a href="{{ route('home') }}" class="block py-2 pl-3 pr-4 {{ request()->routeIs('home') ? 'text-white bg-cyan-600 rounded' : 'text-gray-700 hover:bg-cyan-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-cyan-600' }} lg:p-0 dark:text-white underline" aria-current="page">Home</a>
                </li>
                <li>
                    <a href="{{ route('about') }}" class="block py-2 pl-3 pr-4 {{ request()->routeIs('about') ? 'text-white bg-cyan-600 rounded' : 'text-gray-700 hover:bg-cyan-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-cyan-600' }} lg:p-0 dark:text-gray-400 lg:dark:hover:text-white hover:underline">About</a>
                </li>
                <li>
                    <a href="{{ route('blog') }}" class="block py-2 pl-3 pr-4 {{ request()->routeIs('blog') ? 'text-white bg-cyan-600 rounded' : 'text-gray-700 hover:bg-cyan-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-cyan-600' }} lg:p-0 dark:text-gray-400 lg:dark:hover:text-white hover:underline">Blog</a>
                </li>
                <li>
                    <a href="{{ route('gallery') }}" class="block py-2 pl-3 pr-4 {{ request()->routeIs('gallery') ? 'text-white bg-cyan-600 rounded' : 'text-gray-700 hover:bg-cyan-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-cyan-600' }} lg:p-0 dark:text-gray-400 lg:dark:hover:text-white hover:underline">Gallery</a>
                </li>
                <li>
                    <a href="{{ route('contact') }}" class="block py-2 pl-3 pr-4  {{ request()->routeIs('contact') ? 'text-white bg-cyan-600 rounded' : 'text-gray-700 hover:bg-cyan-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-cyan-600' }} lg:p-0 dark:text-gray-400 lg:dark:hover:text-white hover:underline">Contact us</a>
                </li>
                <li x-data="{ open: false }" class="relative">
                    <button @click="open = !open" class="flex items-center w-full py-2 pl-3 pr-4 {{ request()->routeIs('donate') ? 'text-white bg-cyan-600 rounded' : 'text-gray-700 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-cyan-600' }} lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent hover:underline">
                        Donate in kind
